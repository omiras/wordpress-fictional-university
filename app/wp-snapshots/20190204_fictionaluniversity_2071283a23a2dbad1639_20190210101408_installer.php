...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20190204_fictionaluniversity_2071283a23a2dbad1639_20190210101408_archive.daf';
	const ARCHIVE_SIZE		 = '38213956';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2071283-10101408';
	const VERSION			 = '1.3.4';
