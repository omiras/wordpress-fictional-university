      ...
      this.resultsDiv.html(`
       <div class="row">
        <div class="one-third">
          ...
          ${results.generalInfo.map(item => `<li><a href="${item.permalink}">${item.title}</a> by ${item.authorName} </li>`).join('')}
        ...
        ${results.campuses.length ? '</ul>' : ''}
          ...
          <div class="event-summary__content">
            ...
            <p>${item.description}<a class="nu gray" href="${item.permalink}">Learn more</a></p>
          </div>
        </div>          
